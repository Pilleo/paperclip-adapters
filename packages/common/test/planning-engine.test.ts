...
import { synthesizeDeterministicPlan, formatPlanMarkdown } from "../src/index.js";
...
`;
  ...
  it("formats structured Markdown plan correctly", () => {
    const plan = synthesizeDeterministicPlan(sampleMarkdown, "issue-101");
    ...
    expect(md).toContain("Candidate Test Files");
    expect(md).toContain("`enforcer/src/test/kotlin/io/mazewall/BpfFilterTest.kt`");
